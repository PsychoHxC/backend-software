...
switch ($control) {
    ...
    case 'insertar':
        ...
        if (isset($params->id_area, $params->jefe_area, $params->solicitud_personal, $params->detalle_solicitud)) {
    ...
    case 'editar':
        ...
        if (isset($_GET['id']) && isset($params->id_area) && isset($params->jefe_area) && isset($params->solicitud_personal) && isset($params->detalle_solicitud)) {
            $id = intval($_GET['id']);
            $vec = $area->editar($id, $params);
        } else {
            $vec['resultado'] = 'ERROR';
